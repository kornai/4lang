...
Of these, only {\tt =AGT} and {\tt =PAT} are actually necessary, all other
thematic role-like elements, be they deep cases, surface cases, or
prepositions, have been redefined to rely only on these, see Reform/notes. 

\subsection{More complex notation}

When using [] or (), both can contain not just single nodes but entire
subgraphs. This will have to be rethought in terms of a consistent
