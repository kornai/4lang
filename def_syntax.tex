...
such as IN; FROM; OUT; BETWEEN; AT; FOLLOW; ON; ABOUT, etc. Many of these
...
be could be used in favor of one argument order over the other.
...
either); possessive HAS; and causative CAUSE; these appear frequently in
definitions, and for the last two the passive works reasonably well the
express the obverse. This is not logically strict, {\it metal fatigue can
  cause deadly accidents} is not strictly equivalent to {\it deadly accidents
  are caused by metal fatigue}, but the reversal of the cause/effect relation
is clear (for scope effects, and for the dyadic negation relation LACK see
\cite{Kornai:2020a}). We also keep as primitive the abstract comparative ER
`>', which also governs a case/adposition in many languages.
...
(=PAT). Agent and patients of definiendum and definiens are automatically
...
analytic theory of continuous variables, that 4lang is not equipped to handle. 
