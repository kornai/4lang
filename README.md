...
- the `4lang` concept dictionary, which contains manually written concept definitions, see https://github.com/kornai/4lang/wiki/Fields-in-the-concept-dictionary
